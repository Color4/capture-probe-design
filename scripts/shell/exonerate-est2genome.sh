...
exonerate --query ../../data-clean/031_coding-sequences/$1/*.fasta --target ../../../data-reference/transcriptomes/Trifolium-repens/Nagy/Nagy_Transcriptome.fasta -m est2genome --showtargetgff yes --showalignment no --fsmmemory 1024 --geneseed 250 --percent 95 --bestn 1 --ryo ">%qi length=%ql alnlen=%qal\n>%ti length=%tl alnlen=%tal\n" --targetchunkid 1 --targetchunktotal 8 > ../../data-raw/040_exonerate_e2g/$1/Nagy_transcriptome_e2g_chunk1.output &
